...
├── calibration/                  # Instructor resource: calibration viz + Ising (Instructor_Guide.ipynb); numbered lessons later
...
- **Amazon Braket** — managed Jupyter environment that can run CUDA-Q notebooks.
